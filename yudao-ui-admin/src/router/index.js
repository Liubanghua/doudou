...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [{
        path: 'index',
        component: (resolve) => require(['@/views/educationBureau/schoolpreview/index'], resolve),
        name: '学校预览',
        meta: {title: '学校预览', icon: 'chart', affix: true}
      }
    ]
  }, {
    path: '/user',
    ...
    hidden: true,
    children: [{
        path: 'prin/record/:stuId(\\d+)',
        component: (resolve) => require(['@/views/principal/temprecord/record'], resolve),
        name: 'princ-record',
        meta: {title: '测温记录详情', icon: '', activeMenu: '/temprecord/record'}
      }
    ]
  }, {
    path: '/student',
    ...
    hidden: true,
    children: [{
        path: 'scho/record/:stuId(\\d+)',
        component: (resolve) => require(['@/views/school/temprecord/record'], resolve),
        name: 'scho-record',
        meta: {title: '测温记录详情', icon: '', activeMenu: '/temprecord/record'}
      }
    ]
    ...
    children: [{
        path: 'prin/addStu',
        component: (resolve) => require(['@/views/principal/studentmemt/detail'], resolve),
        name: 'scho-record',
        meta: {title: '添加学生', icon: '', activeMenu: '/studentmemt/detail'}
      }
    ]
  }, {
    path: '/studentmemt',
    ...
    hidden: true,
    children: [{
        path: 'prin/updStu/:stuId(\\d+)',
        component: (resolve) => require(['@/views/principal/studentmemt/detail'], resolve),
        name: 'scho-record',
        meta: {title: '修改学生信息', icon: '', activeMenu: '/studentmemt/detail'}
      }
    ]
  }, {
    path: '/dict',
