  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="日期" prop="date">
        <el-date-picker clearable size="small" v-model="queryParams.date" type="date"
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="班级人数" align="center" prop="packageId">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.packageId === 0" type="danger">系统租户</el-tag>
          <el-tag v-else> {{getPackageName(scope.row.packageId)}} </el-tag>
        </template>
      </el-table-column>
      <el-table-column label="测温正常" align="center" prop="contactName" />
      <el-table-column label="测温异常" align="center" prop="contactMobile" />
      <el-table-column label="未测温" align="center" prop="contactMobile" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['system:tenant:update']">查看详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
