<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="年级人数" align="center" prop="name" />
      <el-table-column label="测温正常" align="center" prop="packageId">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.packageId === 0" type="danger">系统租户</el-tag>
          <el-tag v-else> {{getPackageName(scope.row.packageId)}} </el-tag>
        </template>
      </el-table-column>
      <el-table-column label="测温异常" align="center" prop="contactName" />
      ...
      <el-table-column label="操作" align="center" :show-overflow-tooltip="true">
        <router-link :to="'/class/type/index'" class="link-type">
          <span>查看详情</span>
        </router-link>
      </el-table-column>
    </el-table>
