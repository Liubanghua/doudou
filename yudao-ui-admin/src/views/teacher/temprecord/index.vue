  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="日期">
        <el-date-picker v-model="queryParams.date" clearable size="small" type="date"
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="今日测温" align="center" prop="accountCount">
        <template slot-scope="scope">
          <el-tag> {{scope.row.accountCount}} </el-tag>
        </template>
      </el-table-column>
      <el-table-column label="操作" align="center" :show-overflow-tooltip="true">
        <router-link :to="'/student/type/record'" class="link-type">
          <span>查看今日记录</span>
        </router-link>
      </el-table-column>
    </el-table>
