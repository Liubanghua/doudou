<template>
	<view class="wrap">
		...
		<div v-if="loginPageType === 'currentPhone'">
...
<strong></strong>			<view class="login-bottom-box">
 ...
 */
import {getCodeImg, sendSmsCode, socialAuthRedirect} from "@/static/api/login";
	...
	methods: {
		...
		getCookie() {
		  ...
		  this.loginForm = {
		    ...
		    password: password === undefined ? this.password : decrypt(password),
		    rememberMe: rememberMe === undefined ? false : Boolean(rememberMe),
		    tenantName: tenantName === undefined ? this.tenantName : tenantName,
		    mobile: mobile === undefined ? this.mobile : mobile,
		    mobileCode: mobileCode === undefined ? this.mobileCode : mobileCode,
		    loginType: loginType === undefined ? this.loginType : loginType,
		  };
		},
		showPass() {
