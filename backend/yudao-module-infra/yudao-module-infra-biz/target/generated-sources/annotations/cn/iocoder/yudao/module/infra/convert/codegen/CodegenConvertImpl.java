...
import cn.iocoder.yudao.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO.Column;
import cn.iocoder.yudao.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO.Table;
...
public class CodegenConvertImpl implements CodegenConvert {
    ...
    @Override
    public CodegenTableDO convert(Table bean) {
        if ( bean == null ) {
            return null;
        }
    ...
    @Override
    public List<CodegenColumnDO> convertList03(List<Column> columns) {
        if ( columns == null ) {
            return null;
        }
    ...
    protected CodegenColumnDO columnToCodegenColumnDO(Column column) {
        if ( column == null ) {
            return null;
        }
