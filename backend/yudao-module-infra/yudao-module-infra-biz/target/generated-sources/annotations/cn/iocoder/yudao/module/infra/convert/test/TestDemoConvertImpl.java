...
public class TestDemoConvertImpl implements TestDemoConvert {
    ...
    public TestDemoDO convert(TestDemoCreateReqVO bean) {
        ...
        testDemoDO.setName( bean.getName() );
        testDemoDO.setStatus( bean.getStatus() );
        testDemoDO.setType( bean.getType() );
        testDemoDO.setCategory( bean.getCategory() );
        testDemoDO.setRemark( bean.getRemark() );
