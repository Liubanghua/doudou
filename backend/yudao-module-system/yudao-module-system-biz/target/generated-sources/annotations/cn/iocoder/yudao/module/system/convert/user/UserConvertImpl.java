...
import cn.iocoder.yudao.module.system.controller.admin.user.vo.profile.UserProfileRespVO.Post;
import cn.iocoder.yudao.module.system.controller.admin.user.vo.profile.UserProfileRespVO.Role;
import cn.iocoder.yudao.module.system.controller.admin.user.vo.profile.UserProfileRespVO.SocialUser;
...
import cn.iocoder.yudao.module.system.controller.admin.user.vo.user.UserPageItemRespVO.Dept;
...
public class UserConvertImpl implements UserConvert {
    ...
    public AdminUserDO convert(UserImportExcelVO bean) {
        ...
        adminUserDO.setMobile( bean.getMobile() );
        adminUserDO.setSex( bean.getSex() );
        adminUserDO.setStatus( bean.getStatus() );
    ...
    @Override
    public cn.iocoder.yudao.module.system.controller.admin.user.vo.profile.UserProfileRespVO.Dept convert02(DeptDO bean) {
        if ( bean == null ) {
            return null;
        }

        cn.iocoder.yudao.module.system.controller.admin.user.vo.profile.UserProfileRespVO.Dept dept = new cn.iocoder.yudao.module.system.controller.admin.user.vo.profile.UserProfileRespVO.Dept();
    ...
    @Override
    public List<SocialUser> convertList03(List<SocialUserDO> list) {
        if ( list == null ) {
            return null;
        }

        List<SocialUser> list1 = new ArrayList<SocialUser>( list.size() );
    ...
    protected SocialUser socialUserDOToSocialUser(SocialUserDO socialUserDO) {
